...
public class TargetLock implements ICommand {
    ...
    public void init(double pNow) {
        ...
        Robot.DATA.drivetrain.set(EDriveData.DESIRED_STATE, Enums.EDriveState.TARGET_ANGLE_LOCK);
    ...
    public void shutdown(double pNow) {
        Robot.DATA.drivetrain.set(EDriveData.DESIRED_STATE, Enums.EDriveState.NORMAL);
    }
