...
//        }
    ...
    private void updateDriveTrain() {
        ...
        if(mData.driverinput.isSet(DriveTeamInputMap.DRIVER_ACCEL_LIMIT_BYPASS) &&
                mData.driverinput.get(DriveTeamInputMap.DRIVER_ACCEL_LIMIT_BYPASS) < 0.5) {
        ...
        if (mData.driverinput.isSet(DriveTeamInputMap.DRIVER_SUB_WARP_AXIS) && mData.driverinput.get(DriveTeamInputMap.DRIVER_SUB_WARP_AXIS) > DRIVER_SUB_WARP_AXIS_THRESHOLD ||
                (mData.driverinput.isSet(DriveTeamInputMap.DRIVER_ACCEL_LIMIT_BYPASS) && mData.driverinput.get(DriveTeamInputMap.DRIVER_ACCEL_LIMIT_BYPASS) > 0.5)){
