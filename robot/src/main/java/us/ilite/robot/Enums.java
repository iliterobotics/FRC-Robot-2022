...
public class Enums {
    ...
    public enum FlywheelSpeeds {
        ...
        FAR(                35.0, 31.5 * 1.1, 0.75, HoodState.TARGET_ANGLE, FlywheelWheelState.VELOCITY),
        FAR_TRENCH(         52.0, 22.0 * 1.1, 0.75, HoodState.TARGET_ANGLE, FlywheelWheelState.VELOCITY),
