...
public class CargoSpitTest {
    ...
    @Mock private CargoSpit mCargoSpit;
    @Mock private DJBoothRotationControl mDJBoothRotationControl;
    @Mock private DJBoothPositionControl mDJBoothPositionControl;
    ...
    public void setup() {
        ...
        mDriverInput = spy(new DriverInput( mDrive, mElevator, mHatchFlower, mIntake, mPneumaticIntake, mCargoSpit, mLimelight, mData, mTeleopCommandManager, mAutonomousCommandManager, mFourBar, mDJBoothRotationControl, mDJBoothPositionControl) );
    ...
    public void cleanup() {
        ...
        mDriverInput = spy(new DriverInput( mDrive, mElevator, mHatchFlower, mIntake, mPneumaticIntake, mCargoSpit, mLimelight, mData, mTeleopCommandManager, mAutonomousCommandManager, mFourBar,mDJBoothRotationControl, mDJBoothPositionControl, true));
        mModuleList.setModules( mDriverInput, mDrive );
        mModuleList.modeInit( mClock.getCurrentTime() );
    }
