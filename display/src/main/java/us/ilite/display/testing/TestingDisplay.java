...
/**
 * Allows editing Settings fields posted by NetworkTables. Keeps a history of edited fields,
...
public class TestingDisplay extends Application {
    ...
    private NetworkTable mSettingsNetworkTable = kNetworkTableInst.getTable(Settings.class.getSimpleName().toUpperCase());
...
////                    mLog.debug("kDriveVelocity_kP: ", Settings.kDriveVelocity_kP);
//                    try {
//                        Thread.sleep(500);
