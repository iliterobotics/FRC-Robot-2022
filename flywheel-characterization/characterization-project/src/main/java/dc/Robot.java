...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    master = new TalonFX(13);
    master.setInverted(false);
//    master.setSensorPhase(false);
    master.setNeutralMode(NeutralMode.Brake);

    TalonFX slave0 = new TalonFX(14);
...
//                                                PIDIDX, 10);
    ...
    encoderPosition = ()
        -> master.getSelectedSensorPosition() * encoderConstant;
    encoderRate = ()
        -> master.getSelectedSensorVelocity() * encoderConstant *
               10;
  ...
  public void autonomousPeriodic() {
    ...
    master.set(ControlMode.PercentOutput, autospeed);
