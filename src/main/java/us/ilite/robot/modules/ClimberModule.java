...
public class ClimberModule extends Module{
    ...
    public ClimberModule() {
        ...
        mCL12.configGetSupplyCurrentLimit(new SupplyCurrentLimitConfiguration(true, 21, 22, 0.01));
        mCLMR11.configGetSupplyCurrentLimit(new SupplyCurrentLimitConfiguration(true, 21, 22, 0.01));
