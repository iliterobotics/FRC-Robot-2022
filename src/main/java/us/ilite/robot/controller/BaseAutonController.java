...
public class BaseAutonController extends AbstractController {
    ...
    public BaseAutonController() {
        ...
        mTrajectoryConfig = new TrajectoryConfig(1, 1);
        ...
        mTrajectoryConfig.addConstraint(new CentripetalAccelerationConstraint(0.75));
        mTrajectoryConfig.addConstraint(new DifferentialDriveKinematicsConstraint(k,1));
